...
const { getExtent, getGeomType, getHasZ, isTable } = require('./utils')
...
function renderLayer (data = {}, { params = {}, query = {} } = {}) {
  ...
  json.hasZ = getHasZ(data)
  if (metadata.enableZDefaults !== null) json.enableZDefaults = metadata.enableZDefaults
  if (metadata.zDefault !== null) json.zDefault = metadata.zDefault
